...
export default function ResultsScreen() {
  ...
  return (
    <div className="container mx-auto p-4 min-h-[80vh]">
      ...
      <form className="flex flex-col md:flex-row items-end justify-center gap-4 flex-wrap mb-4" onSubmit={handleSearch}>
        <select
          className="bg-white px-2 py-3 w-full md:w-48 font-bold text-sm text-black rounded-md ring-1 ring-gray-300 focus:ring-2 focus:outline-none focus:ring-orange-500"
        ...
        <button className="bg-orange-500 px-2 py-3 w-full md:w-24 flex items-center justify-center font-bold uppercase text-sm text-white hover:bg-orange-700 rounded-md">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between space-x-0 md:space-x-4">
                ...
                <div className="mt-2 md:mt-0">
                  ...
                  <p className="flex items-center text-gray-600">
                    <FiMapPin className="mr-1" /> {event.city}, {event.country}
                  </p>
                </div>
              </div>
            </li>
